...
public class DeliveryListView extends LinearLayout {
    TextView text_price;
    TextView text_num;
    ...
    public DeliveryListView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.view_deliverylist, this, true);
